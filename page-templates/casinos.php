...
<section id="skip-link-content" class="page-header">
  <div class="wrap row">
    <div class="page-header__title-area">
      <h1 class="page-header__title">Casinos & Gaming</h1>
      <p class="page-header__description">Serve your most loyal guests just as easily online as offline</p>
      <div class="btn-holder">
        <a class="btn btn-primary" href="#">request a demo</a>
      </div>
    </div>
    <div class="page-header__feature">
      <img src="<?php echo get_template_directory_uri(); ?>/images/casinos-header.png" alt="">
