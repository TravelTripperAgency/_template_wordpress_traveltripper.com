...
<section id="skip-link-content" class="page-header">
  <div class="wrap row">
    ...
    <div class="page-header__feature">
      <img srcset="<?php echo get_template_directory_uri(); ?>/images/solutions-ttweb-header.png, <?php echo get_template_directory_uri(); ?>/images/solutions-ttweb-header@2x.png 2x" src="<?php echo get_template_directory_uri(); ?>/images/solutions-ttweb-header@2x.png" alt="Websites Header Graphic">
