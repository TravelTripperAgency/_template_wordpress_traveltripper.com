...
// Get the first category so long as it is a single post
...
<article <?php post_class( 'post' ); ?>>
    <div class="col-sm-6"> <?php
        if ( has_post_thumbnail() ) { ?>
                <a href="<?php if ( get_field( 'resource_link' ) ) { esc_url( the_field( 'resource_link' ) ); } else { esc_url( the_permalink() ); } ?>"><?php the_post_thumbnail(); ?></a> <?php
        } else { ?>
                <a href="<?php if ( get_field( 'resource_link' ) ) { esc_url( the_field( 'resource_link' ) ); } else { esc_url( the_permalink() ); } ?>"><?php traveltripper_default_thumbnail(); ?></a> <?php
        } ?>
    </div>
    <div class="col-sm-6"> <?php
