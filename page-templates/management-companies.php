...
<section id="skip-link-content" class="page-header">
  <div class="wrap row">
    <div class="page-header__title-area">
      <h1 class="page-header__title">Hotel Brands & Management Companies</h1>
      <p class="page-header__description">STAY AHEAD OF MARKETING & DISTRIBUTION TRENDS WITH OUR SCALABLE MULTI-PROPERTY SOLUTION.</p>
      <div class="btn-holder">
        <a class="btn btn-primary" href="#">request a demo</a>
      </div>
    </div>
    <div class="page-header__feature">
      <img src="<?php echo get_template_directory_uri(); ?>/images/management-companies-header.png" alt="">
